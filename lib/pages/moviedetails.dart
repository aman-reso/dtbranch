...
class MovieDetailsState extends State<MovieDetails> {
                ...
                child: InkWell(
                  ...
                  child: Column(
                    children: [
                      ...
                      Visibility(
                        visible: videoDetailsProvider.tabClickedOn == "related",
                        child: Container(
                          width: MediaQuery.of(context).size.width,
                          height: 2,
                          color: white,
                ...
                child: InkWell(
                  ...
                  child: Column(
                    children: [
                      ...
                      Visibility(
                        visible:
                            videoDetailsProvider.tabClickedOn == "moredetails",
                        child: Container(
                          width: MediaQuery.of(context).size.width,
                          height: 2,
                          color: white,
  ...
  Widget _buildDirector() {
    if (directorList != null && (directorList?.length ?? 0) > 0) {
      return Container(
        width: MediaQuery.of(context).size.width,
        constraints: BoxConstraints(minHeight: Dimens.heightCast),
        padding: const EdgeInsets.fromLTRB(20, 0, 20, 0),
        child: Row(
          mainAxisSize: MainAxisSize.max,
          mainAxisAlignment: MainAxisAlignment.start,
